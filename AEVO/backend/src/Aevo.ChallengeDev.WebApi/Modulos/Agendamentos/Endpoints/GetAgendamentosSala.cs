...
public class GetAgendamentosSalaHandler(Context context) : ICaseHandler<GetAgendamentosSala, List<AgendamentoView>>
{
    public async Task<Result<List<AgendamentoView>>> Handle(GetAgendamentosSala req, CancellationToken ct)
    {
        try
        {
